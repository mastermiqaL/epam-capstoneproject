...
public class ProductDto implements Serializable {
    ...
    public ProductDto(Integer id, String name, String category, Integer price, String sellerUsername, Integer stock, LocalDate placeDate, Integer rating, String secondhand, String imageUrl, String description) {
        this.id = id;
        this.name = name;
